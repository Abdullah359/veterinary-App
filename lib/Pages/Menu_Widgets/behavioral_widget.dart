...
class BehavioralWidget extends StatefulWidget {
  const BehavioralWidget({
    super.key,
  });

  @override
  State<BehavioralWidget> createState() => _BehavioralWidgetState();
}

class _BehavioralWidgetState extends State<BehavioralWidget> {
