...
import 'package:vaterinarystore/Pages/appointment/appointment_page.dart';

class VeterinaryWidget extends StatefulWidget {
  const VeterinaryWidget({
    super.key,
  });

  @override
  State<VeterinaryWidget> createState() => _VeterinaryWidgetState();
}

class _VeterinaryWidgetState extends State<VeterinaryWidget> {
  // Veterinary Doctors Image URL
  final List<String> vetDocsImageURL = [
    'assets/images/doctors/doc_shoko.jpg',
